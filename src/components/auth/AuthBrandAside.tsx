...
export function AuthBrandAside() {
  return (
    <aside className="group/aside relative hidden min-h-dvh flex-col justify-between overflow-hidden bg-muted/40 px-8 py-10 md:flex lg:px-12 lg:py-12">
      <AuthGhostGrid className="transition-opacity duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover/aside:opacity-70 motion-reduce:transition-none" />
      <div className="relative z-[1] flex flex-col gap-10">
        ...
        >
          <span
            className="d2q-auth-brand-mark flex h-10 w-10 shrink-0 items-center justify-center rounded-sm bg-primary text-sm font-bold text-primary-foreground shadow-sm"
            aria-hidden
          >
            D2
          </span>
          <div className="flex flex-col leading-none">
            <span className="font-heading text-lg font-extrabold tracking-tight text-[var(--d2q-blue)] transition-colors duration-200 group-hover:text-primary">
              Doc2Quiz
            </span>
        ...
        <div className="max-w-md space-y-5">
          <h2 className="font-heading text-balance text-[clamp(2rem,4.5vw,2.75rem)] font-extrabold leading-[1.08] tracking-[-0.02em] text-accent-foreground">
            Study mode,
