...
export type QuestionReviewNavigatorProps = {
  ...
  className?: string;
  /** When set, status + Start quiz render in the same card as the navigator (single shell). */
        ...
        <div className="shrink-0 border-t border-border/60 bg-card/95 px-4 py-3 backdrop-blur-sm">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {finish.backToLibraryHref ? (
                <Link
                  href={finish.backToLibraryHref}
                  className="text-xs font-medium text-chart-2 underline-offset-2 hover:underline"
                >
                  Back to library
                </Link>
              ) : null}
